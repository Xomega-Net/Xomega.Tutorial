...
{
    public partial class SalesOrderReasonViewBase : BlazorDetailsView
    {
        [Inject] protected SalesOrderReasonViewModel VM { get; set; }
        ...
        {
            VM = viewModel as SalesOrderReasonViewModel;
