...
namespace AdventureWorks.Services.Common
{
    ...
    ///</summary>
    public class ProductSubcategoryServiceClient : RestApiClient, IProductSubcategoryService
    {
        public ProductSubcategoryServiceClient(IHttpClientFactory httpClientFactory, RestApiConfig apiConfig,
        ...
        public virtual async Task<Output<ICollection<ProductSubcategory_ReadEnumOutput>>> ReadEnumAsync(CancellationToken token = default)
        {
            ...
            using (var resp = await Http.SendAsync(msg, HttpCompletionOption.ResponseHeadersRead, token))
            {
                ...
                return JsonSerializer.Deserialize<Output<ICollection<ProductSubcategory_ReadEnumOutput>>>(content, SerializerOptions);
            }
        }
    }
}